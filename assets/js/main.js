    ...
    <article class="prod-card">
      ...
      <div class="info-sec">
        ...
        <div class="prod-cta-row prod-cta-row--wa">
          ...
          <a href="${igOrderHref}" target="_blank" rel="noopener noreferrer" class="prod-ig-order-btn" data-ig-link aria-label="حسابنا على إنستغرام — @pharma_store.me">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M7.75 2h8.5A5.75 5.75 0 0 1 22 7.75v8.5A5.75 5.75 0 0 1 16.25 22h-8.5A5.75 5.75 0 0 1 2 16.25v-8.5A5.75 5.75 0 0 1 7.75 2Zm0 1.8A3.95 3.95 0 0 0 3.8 7.75v8.5a3.95 3.95 0 0 0 3.95 3.95h8.5a3.95 3.95 0 0 0 3.95-3.95v-8.5a3.95 3.95 0 0 0-3.95-3.95h-8.5Zm8.95 1.45a1.05 1.05 0 1 1 0 2.1 1.05 1.05 0 0 1 0-2.1ZM12 7a5 5 0 1 1 0 10 5 5 0 0 1 0-10Zm0 1.8a3.2 3.2 0 1 0 0 6.4 3.2 3.2 0 0 0 0-6.4Z"/></svg>
            إنستغرام
          </a>
          </div>
...
function mountProductWaStickyBar(p) {
  ...
  if (igHref) {
    ...
    ig.className = 'prod-wa-sticky__btn prod-wa-sticky__btn-ig';
    ig.href = igHref;
    ig.target = '_blank';
    ig.rel = 'noopener noreferrer';
    ig.setAttribute('aria-label', 'إنستغرام الصيدلية');
    ig.innerHTML =
      '<span class="prod-wa-sticky__ico" aria-hidden="true"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M7.75 2h8.5A5.75 5.75 0 0 1 22 7.75v8.5A5.75 5.75 0 0 1 16.25 22h-8.5A5.75 5.75 0 0 1 2 16.25v-8.5A5.75 5.75 0 0 1 7.75 2Zm0 1.8A3.95 3.95 0 0 0 3.8 7.75v8.5a3.95 3.95 0 0 0 3.95 3.95h8.5a3.95 3.95 0 0 0 3.95-3.95v-8.5a3.95 3.95 0 0 0-3.95-3.95h-8.5Zm8.95 1.45a1.05 1.05 0 1 1 0 2.1 1.05 1.05 0 0 1 0-2.1ZM12 7a5 5 0 1 1 0 10 5 5 0 0 1 0-10Zm0 1.8a3.2 3.2 0 1 0 0 6.4 3.2 3.2 0 0 0 0-6.4Z"/></svg></span><span class="prod-wa-sticky__txt">إنستغرام</span>';
