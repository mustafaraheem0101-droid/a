...
function buildProductCardHtml(p, opts) {
  ...
  <div class="pc-footer">
    <div class="pc-footer__tags">
      ...
      <a href="${escHtml(igFabHref)}" class="pc-ig-fab" data-ig-link target="_blank" rel="noopener noreferrer" aria-label="إنستغرام صيدلية شهد محمد">${igSvg}</a>
    </div>
